...
def set_hparams(
    config="", exp_name="", hparams_str="", print_hparams=True, global_hparams=True, is_infer=False
):
    if config == "" and exp_name == "":
        ...
        parser.add_argument("--ckpt_step", default="last")
        ...
        if os.path.exists(ckpt_config_path):
            with open(ckpt_config_path) as f:
                ...
                if saved_hparams_ is not None:
                    hparams_.update(saved_hparams_)

    hparams_["work_dir"] = args_work_dir
    hparams_["n_timesteps"] = 10
    # hparams_["test_inference_list"] = 0

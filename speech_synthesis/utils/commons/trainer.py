...
class Trainer:
    def __init__(
        ...
        self.resume_from_checkpoint = (
            resume_from_checkpoint if resume_from_checkpoint >= -1 else None
        )
        self.seed = seed
        self.debug = debug
        # model and optm
    ...
    def run_evaluation(self, test=False):
        ...
        if self.proc_rank == 0 and not test and self.global_step % hparams["save_step_interval"] == 0:
    ...
    def train(self):
        ...
        if self.num_sanity_val_steps > 0 and self.proc_rank == 0: # @@@@@@@@@@@
        ...
        while True:
            ...
            for batch_idx, batch in enumerate(train_pbar):
                if (
                    ...
                    and not self.fisrt_epoch and self.proc_rank == 0 # @@@@@@@@@@@
                ):
                    self.run_evaluation()

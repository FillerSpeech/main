...
def get_last_checkpoint(work_dir, steps=None):
    ...
    if len(ckpt_paths) > 0:
        ...
        print('@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@')
        print()
        print("Loaded ckpt's global step: ", checkpoint['global_step'])
        print()
        print('@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@')
        print('@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@')
    return checkpoint, last_ckpt_path

def get_best_ckpt(work_dir):
    ckpt_path = f"{work_dir}/model_ckpt_best.pt"
...
def get_all_ckpts(work_dir, steps=None):
    if steps is None:
        ...
        ckpt_path_pattern = f'{work_dir}/model_ckpt_best.pt'
        return [ckpt_path_pattern]
    else:
